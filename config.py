...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Taniya_4u")
BOT_USERNAME = getenv("BOT_USERNAME", "Toxi_musicbot")
BOT_NAME = getenv("BOT_NAME", "˹𝐀ɴɴɪᴇ ✘ 𝙼ᴜsɪᴄ˼ ♪")
ASSUSERNAME = getenv("ASSUSERNAME", "Alishacute")
EVALOP = list(map(int, getenv("EVALOP", "6797202080").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002035023865)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
# External APIs - Get these from their respective providers
GPT_API = getenv("GPT_API")
DEEP_API = getenv("DEEP_API")
OWNER_ID = int(getenv("OWNER_ID", 7336605438))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/toxic_creation")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/friends_chatting_group_adda")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/5a7c6fb746c0747ced448.jpg"
)
PING_VID_URL = getenv(
